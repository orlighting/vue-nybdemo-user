  ...
  <div>
    ...
    <div class="card bbxx" style="width: 1000px">
      <div class="chartUser">
        ...
        <el-form :model="declareForm" status-icon label-width="30px" class="demo-ruleForm" style="padding-right: 30px" enctype="multipart/form-data" action="http://192.168.1.101:8445/api/handin/detail" method="post">
          <div class="helpinfo">
    ...
    declareFormed(){
      // console.log(this.declareForm.leaderF);
          ...
          let formdata2 = new FormData()
			    ...
			    formdata1.append("preExpoFile", ip1.files[0]);
          formdata2.append("investmentPlanFile", ip2.files[0]);
          ...
          var axios = require('axios')
				axios({
					url:'http://192.168.1.101:8445/api/handin/detail',
					method: 'post',
					data: {
              ...
              //  往届展会情况文档id
              preExpoFile : ip1.files[0] ,
              // 招商方案文档id
              investmentPlanFile : ip2.files[0],
