...
export default {
  ...
  computed:{
    leaderPresent(){
      return (this.declareForm.leaderN & 1).toString()+(this.declareForm.leaderF & 1).toString()+(this.declareForm.leaderA & 1).toString()+(this.declareForm.leaderP & 1).toString()+(this.declareForm.leaderD & 1).toString()
    }
