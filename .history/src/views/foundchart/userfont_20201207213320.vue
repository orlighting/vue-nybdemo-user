        ...
        <el-form :model="declareForm" status-icon label-width="30px" class="demo-ruleForm" style="padding-right: 30px" enctype='multipart/form-data'>
          ...
          <el-row :gutter="0">
            ...
            <el-col :span="7">
              <el-form-item>
                <label>开始时间</label>
                <el-input type="dateTime" ref="beginTime" name="beginTime" v-model="declareForm.beginTime" auto-complete="off"
...
export default {
  ...
  methods: {
    ...
    declareFormed() {
      ...
      // 是否邀请境外参展商或有关机构
      formdata.append("foreign", this.declareForm.foreignOrg);
      // 展会名称
      ...
      axios
        .post("http://10.28.160.250:8445/api/handin/detail", formdata)
