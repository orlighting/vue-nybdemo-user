...
export default {
  ...
  methods: {
    ...
    declareFormed() {
      ...
      //开始时间
      formdata.append("startTime", dateFormat(this.declareForm.beginTime,this.declareForm.beginTime));
      //结束时间
      formdata.append("endTime", dateFormat(this.declareForm.beginTime,this.declareForm.endTime));
      // 展会内容
