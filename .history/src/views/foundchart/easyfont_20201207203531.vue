...
<script>
import {sendEasy} from '../../network/sendForm';
export default {
  name: "userfont",
  components: {},
  data() {
  ...
  methods: {
    ...
    declareFormed() {
      ...
      // 协办单位
      formdata.append("supportComp", this.declareForm.assistingComp);
      // 指导单位
      formdata.append("orderComp", this.declareForm.assistingComp);
      // 批准单位
      ...
      //开始时间
      formdata.append("startTime", this.declareForm.startTime);
      //结束时间
      formdata.append("endTime", this.declareForm.endTime);
      // 展会内容
      formdata.append("meetState", this.declareForm.expocont);
      // 财政资金数额
      formdata.append("finanFund", this.declareForm.finanFund);
      // 自筹资金数额
      formdata.append("selfFund", this.declareForm.raisedFond);
      //出席领导情况
      formdata.append("leaderState", this.leaderPresent);
      //同期活动
      formdata.append("activityBrief", this.concurrentEvent);
      //展会工作方案文档
      ...
      sendEasy(formdata).then(successResponse=>{
