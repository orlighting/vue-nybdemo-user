    ...
    <div class="card bbxx" style="width: 1000px">
      <div class="chartUser">
        ...
        <el-form :model="declareForm" status-icon label-width="30px" class="demo-ruleForm" style="padding-right: 30px" enctype='multipart/form-data'>
            ...
            <el-col :span="12">
              <el-form-item>
                ...
                <el-input type="number" ref="hostcrlc" v-model="declareForm.hostcrlc" auto-complete="off"
                          placeholder="请填写存数字，默认单位‘月’"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item>
                ...
                <el-input type="number" ref="hostarea" v-model="declareForm.hostarea" auto-complete="off"
                          placeholder="请填写存数字，默认单位‘m²’"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-form-item>
            <label>展会内容</label>
            <el-input type="textarea" ref="expocont" maxlength="5" v-model="declareForm.expocont" auto-complete="off"
                      placeholder=""></el-input>
          </el-form-item>
