    ...
    declareFormed(){
      // console.log(this.declareForm.leaderF);
          ...
          var formdata2 = new FormData()
			    ...
			    var formdata1 = formdata1.append('preExpoFile',ip1.files[0]);
          var formdata2 = formdata2.append('investmentPlanFile',ip2.files[0]);
          console.log(ip1.files[0])
          console.log(formdata1.append('preExpoFile',ip1.files[0]))
