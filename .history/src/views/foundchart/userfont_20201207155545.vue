          ...
          <el-form-item>
            ...
            <el-col :span="12">
              <p style="font-size: 10px">
                ...
                <input style="vertical-align:middle;" ref="leaderA" type="checkbox" v-model="declareForm.leaderF" name="leaders" auto-complete="off"
                       placeholder=""></input>
              </p>
            </el-col>
            <el-col :span="12">
              <p style="font-size: 10px">
                ...
                <input style="vertical-align:middle;" ref="leaderP" type="checkbox" v-model="declareForm.leaderF" name="leaders" auto-complete="off"
                       placeholder=""></input>
              </p>
            </el-col>
            <el-col :span="12">
              <p style="font-size: 10px">
                ...
                <input style="vertical-align:middle;" ref="leaderD" type="checkbox" v-model="declareForm.leaderF" name="leaders" auto-complete="off"
                       placeholder=""></input>
              </p>
            </el-col>
          </el-form-item>
