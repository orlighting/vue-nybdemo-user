  ...
  methods:{
    ...
    declareFormed(){
      // console.log(this.declareForm.leaderF);
          ...
          console.log(formdata.get('preExpoFile'))
          console.log(formdata.get('investmentPlanFile'))
        ...
        //       finanFund : this.declareForm.finanfond,
        //       otherFund : this.declareForm.otherfond,
        //       area: this.declareForm.hostarea,
        //       domestic:this.declareForm.expofrom1,
        //       foreign:this.declareForm.expofrom2,
        //       name : this.declareForm.name,
        //       hostcomp : this.declareForm.hostcomp,
        //       fundcomp : this.declareForm.fondcomp,
        ...
        //       content : this.declareForm.expocont,
        ...
        //       leaderF : this.declareForm.leaderF,
			  ...
			  //     }
				...
				// })
				// }
					axios.post('http://192.168.1.101:8445/api/handin/detail', {
              // userId : this.$store.getters.token,
              ...
              // declare : this.declareForm.content,
              //  往届展会情况文档id
              preExpoFile : formdata,
              // 招商方案文档id
              investmentPlanFile : formdata,
              // time : this.declareForm.time,
              // view1 : this.declareForm.viewfrom1,
              // view2 : this.declareForm.viewfrom2,
              // leaderD : this.declareForm.leaderN,
