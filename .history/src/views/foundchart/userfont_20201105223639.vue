        ...
        <el-form :model="declareForm" status-icon label-width="30px" class="demo-ruleForm" style="padding-right: 30px" enctype='multipart/form-data'>
          ...
          <el-form-item>
            ...
            <el-input type="textarea" ref="content" v-model="declareForm.content" auto-complete="off"
              ...
              <form enctype='multipart/form-data' action="http://192.168.1.101:8445/api/handin/detail" method="post">
                <input type="file" name='preExpoFile' accept=".pdf">
                <input type="file" name='investmentPlanFile' accept=".pdf">
                <input type="submit">
              </form >  

          <el-form-item style="padding-bottom:30px; padding-right: 30px" enctype='multipart/form-data'>

            <el-button class="subBtn" type="submit" v-on:click="declareFormed">提交</el-button>
          </el-form-item>
  ...
  methods:{
    ...
    declareFormed(){
      // console.log(this.declareForm.leaderF);
          ...
          console.log(formdata1.get('preExpoFile'))
          ...
          var axios = require('axios')
              ...
              //  往届展会情况文档id
              preExpoFile : formdata1.get('preExpoFile') ,
              // 招商方案文档id
              investmentPlanFile : formdata2.get('preExpoFiinvestmentPlanFilele'),
