...
export default {
  ...
  created(){
    getDetail(this.$store.getters.token).then(res => {
      ...
      // this.declareForm.leaderN= res.data.leaderPresent.substr(0),
      console.log(res.data.leaderPresent),
      this.declareForm.leaderF= false,
      this.declareForm.leadersA= false,
      this.declareForm.leadersP= false,
      this.declareForm.leadersD= false
    })
