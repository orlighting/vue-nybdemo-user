  ...
  <div>
    ...
    <div class="card bbxx" style="width: 1000px">
      <div class="chartUser">
        ...
        <form :model="declareForm" status-icon label-width="30px" class="demo-ruleForm" style="padding-right: 30px" enctype="multipart/form-data" action="http://192.168.1.101:8445/api/handin/detail" method="post">
          <div class="helpinfo">
          ...
          <form-item>
            ...
            <el-input type="textarea" ref="content" v-model="declareForm.content" auto-complete="off"
					...
					<form-item enctype="multipart/form-data">
						<div class="inputFile1"> 
							<label>以往会展情况</label><br />
							<input type="file" ref="inputFile1"  placeholder="请提交PDF格式的以往会展情况"
              accept=".pdf" name="preExpoFile"></input>
						</div>

						<div class="inputFile2">
							<label>招商方案</label><br/>
							<input type="file" ref="inputFile2"  placeholder="请提交PDF格式的招商方案" accept=".pdf" name="investmentPlanFile"></input>
						</div>

							
					</form-item>

          <form-item style="padding-bottom:30px; padding-right: 30px">

            <el-button class="subBtn" type="submit">提交</el-button>
          </form-item>
    ...
    declareFormed(){
      // console.log(this.declareForm.leaderF);
          ...
          let formdata2 = new FormData()
			    ...
			    formdata1.append("file", ip1.files[0]);
          formdata2.append("file", ip2.files[0]);
          console.log(ip1.files[0])
          ...
          console.log(this.declareForm)
              ...
              area: this.declareForm.hostarea,
              ...
              //  往届展会情况文档id
              preExpoFile : formdata1 ,
              // 招商方案文档id
              investmentPlanFile : formdata2,
