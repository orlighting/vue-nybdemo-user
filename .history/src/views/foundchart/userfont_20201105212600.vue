  ...
  <div>
    ...
    <div class="card bbxx" style="width: 1000px">
      <div class="chartUser">
        ...
        <form :model="declareForm" status-icon label-width="30px" class="demo-ruleForm" style="padding-right: 30px" enctype=“multipart/form-data”>
          <div class="helpinfo">
            ...
            <el-input type="textarea" ref="content" v-model="declareForm.content" auto-complete="off"
              ...
              accept=".pdf"></input>
						...
						<div class="inputFile2">
							<label>招商方案</label><br/>
							<input type="file" ref="inputFile2"  placeholder="请提交PDF格式的招商方案" accept=".pdf"></input>
						</div>
