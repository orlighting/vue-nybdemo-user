<template>
  <div>
    ...
    <div class="card bbxx" style="width: 1000px">
      <div class="chartUser">
        ...
        <el-form :model="declareForm" status-icon label-width="30px" class="demo-ruleForm" style="padding-right: 30px" enctype='multipart/form-data'>
          ...
          <el-form-item>
            <label>同期活动数量</label>
            <el-input type="number" ref="activityNum" v-model="declareForm.activityNum" auto-complete="off" placeholder="平方米"></el-input>
          </el-form-item>
    ...
    <el-input type="number" ref=" displayObj" v-model="declareForm.displayObj" auto-complete="off"></el-input>
              ...
              <el-form-item>
                <label>观展总人数</label>
                <el-input type="number" ref="visitorNum" v-model="declareForm.visitorNum" auto-complete="off"></el-input>
              </el-form-item>
              <el-form-item>
                <label>成交额（含意向）</label>
