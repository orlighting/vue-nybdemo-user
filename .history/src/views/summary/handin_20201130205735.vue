    ...
    <div class="card bbxx" style="width: 1000px">
      <div class="chartUser">
        ...
        <el-form :model="declareForm" status-icon label-width="30px" class="demo-ruleForm" style="padding-right: 30px" enctype='multipart/form-data'>
          ...
          <el-form-item>
            <label>参展企业数量</label>
          <el-input type="text" ref=" companyNum" v-model="declareForm. companyNum" auto-complete="off"></el-input>
          </el-form-item>
          <el-form-item>
            <label>展出总面积</label>
            <el-input type="text" ref="area" v-model="declareForm.area" auto-complete="off"
...
export default {
  ...
  methods: {
    ...
    declareFormed() {
      ...
      axios
        .post("http://192.168.1.102:8445/api/handin/detail", formdata)
