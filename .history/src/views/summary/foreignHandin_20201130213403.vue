...
export default {
  ...
  methods: {
    declareFormed() {
      ...
      formdata.append("id", this.$store.getters.token);
      ...
      formdata.append("nextWorkDirection", nextWorkDirection);

      console.log(formdata);

      var axios = require("axios");
      axios
        .post("http://192.168.1.102:8445/api/handin/summary ", formdata)
