<template>
  <div>
    ...
    <el-input type="number" ref=" displayObj" v-model="declareForm.displayObj" auto-complete="off"></el-input>
              ...
              <el-form-item>
                <label>观展总人数</label>
                <el-input type="number" ref="visitorNum" v-model="declareForm.visitorNum" auto-complete="off" placeholder="个"></el-input>
              </el-form-item>
              <el-form-item>
                <label>成交额（含意向）</label>
          ...
          <el-form-item>
            ...
            <el-input type="textarea" ref="lightSpot" :maxlength="200" v-model="declareForm.lightSpot" auto-complete="off"
...
const cityOptions = ["北京市", "北京市", "河北省", "山西省","内蒙古自治区","辽宁省","吉林省","黑龙江省","上海市","江苏省","浙江省","安徽省","福建省","江西省","山东省","河南省","湖北省","湖南省","广东省","广西壮族自治区","海南省","重庆市","四川省","贵州省","云南省","西藏自治区","陕西省","甘肃省","青海省","宁夏回族自治区","新疆维吾尔自治区","台湾省","香港特别行政区","澳门特别行政区"];
export default {
  name: "userfont",
  components: {},
  data() {
  ...
  methods: {
    ...
    declareFormed() {
      ...
      formdata.append("meetId", this.$store.declareForm.meetId);
      ...
      // 参展省市自治区情况
      formdata.append("provinceState", this.provinceState);
      // 参展商数量
      ...
      axios
        .post("http://192.168.43.226:8445/api/handin/summary", formdata)
