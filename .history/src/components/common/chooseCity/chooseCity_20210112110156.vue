<template>
    <div class="chooseCity">
      ...
      <Select v-model="model2" style="min-width:10px;max-width: 100px;" v-if="showSecond" @on-change="deleteModel(2)">
        <Option v-for="item in secondFloorDatas" :value="item.id" :key="item.id">{{ item.name }}</Option>
      </Select>
      <Select v-model="model3" style="min-width:10px;max-width: 100px;" v-if="showThird" >
