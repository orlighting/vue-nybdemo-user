<template>
  <div class="exhiList">
    ...
    <p class="exhtitle">
      <i class="fa fa-th-large fa-lg" style="margin-right: 5px"></i
      >正在申请中的细节申报
    </p>
    <div class="exht" style="text-align: center; width: 90%">
      <span style="width: 20%">id</span
      ><span style="width: 50%">展会名称</span
      ><span style="width: 30%">审核状态</span>
    </div>
    <exhi-list-item
...
import { getDetailExhiState } from "../../../network/exhiState.js";
// 将界面导出
export default {
  name: "exhiList",
