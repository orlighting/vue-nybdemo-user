      ...
      <div class="chartUser">
        ...
        <el-form :model="EasyForm" status-icon label-width="30px" class="demo-ruleForm" style="padding-right: 30px">
          ...
          <el-form-item style="margin-top: 20px">
            <label>展会名称</label>
            <el-input type="text" v-model="easyForm.name" auto-complete="off"
                      placeholder="博览会/展会/会议名"></el-input>
          </el-form-item>

          <el-form-item style="margin-top: 20px">
            <label>展会对应计划id</label>
            <el-input type="number" v-model="easyForm.dmeetid" auto-complete="off"
                      placeholder="例：2020091234"></el-input>
          </el-form-item>

          <el-form-item>
            <label>主办单位</label>
            <el-input type="text" v-model="easyForm.host" auto-complete="off"
          ...
          <el-form-item style="width: 300px">
            <label>举办时间</label>
            <el-input type="date" v-model="easyForm.time" auto-complete="off"
                      placeholder=""></el-input>
          </el-form-item>

          <el-form-item>
            <label>举办地点</label>
            <el-input type="text" v-model="easyForm.place" auto-complete="off"
                      placeholder="xx省 xx市 xx区 xx路xxx号"></el-input>
          </el-form-item>

          <el-form-item style="padding-bottom: 30px">
            <label>备注</label>
            <el-input type="textarea" v-model="easyForm.ps" auto-complete="off"
                      placeholder=""></el-input>
          </el-form-item>
